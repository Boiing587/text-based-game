...
while True:
  ...
  choice = input("> ")
  clearScreen()
  if choice.lower() == "enter the mansion":
    ...
    while True:
      ...
      choice = input("> ")
      if choice.lower() == "walk down the hallway":
        getKey = 0
        while True:
          clearScreen()
          tLeft()
          ...
          if choice.lower() == "take fork":
          ...
          elif choice.lower() == "straight ahead":
            while True:
              clearScreen()
              lockedDoor()
              ...
              if getKey == 0:
                ...
                print("What do you want to do? \n - Turn around \n - Use simple key")
              choice = input("> ")
              if choice.lower() == "turn around":
                break
              elif choice.lower() == "use simple key" and getKey == 0:
                tw("You do not have the key to open this door.")
              elif choice.lower() == "use simple key" and getKey == 1:
                ...
                while True:
                  ...
                  if choice.lower() == "go back":
                    ...
                    if getKey == 0:
                      ...
                      if choice.lower() == "go back":
                        continue
                      elif choice.lower() == "use rotten key":
                        ...
                        while True:
                          ...
                          if choice.lower() == "go back":
                            ...
                            time.sleep(1)
                          elif choice.lower() == "walk to the right":
                            while True:
                              clearScreen()
                              tRight()
                              ...
                              if choice.lower() == "take fork":
                                ...
                                while True:
                                  ...
                                  if choice.lower() == "go back":
                                    break
                                  elif choice.lower() == "search the room further" and destroyedWall == 0:
                                    while True:
                                      print()
                                      ...
                                      elif choice.lower() == "push it back in":
                                        print()
                                  ...
                                  elif choice.lower() == "search the room further" and destroyedWall == 1:
                                    print()
                                    tw("You already searched the room. There is nothing else to find.")

                          elif choice.lower() == "walk to the left" and destroyedWall == 0:
                            print()
                            tw("That's a wall.")
                          
                          elif choice.lower() == "walk to the left" and destroyedWall == 1:
                            ##########
                            while True:
                              clearScreen()
                              deadEnd()
                  ...
                  elif choice.lower() == "walk straight down":
                    clearScreen()
                    hallwayStraight()
                      ...
                      if choice.lower() == "yes":
                        ...
                        while True:
                          ...
                          if getEquip == 0:
                            ...
                            choice = input("> ")
                            if choice.lower() == "pick up weapon and armor":
                    ...
                    while True:
                      ...
                      if getEquip == 1:
                        ...
                        if choice.lower() == "run away":
                          ...
                          break
                        elif choice.lower() == "kill skeleton":
                          clearScreen()
                          time.sleep(1)
                          skelHeadPreHit()
                          time.sleep(2)
            ...
            while True:
              ...
              if getKey == 0:
                ...
                print("What do you do? \n - Go back")
              choice = input("> ")
              if choice.lower() == "grab simple key":
                getKey = 1
              elif choice.lower() == "go back":
                break

      elif choice.lower() == "turn around":
        while True:
          clearScreen()
          deadEnd()
  ...
  elif choice.lower() == "go around the mansion":
